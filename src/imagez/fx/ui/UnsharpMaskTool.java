 ...
 * @author notzed
 */
public class UnsharpMaskTool extends JPanel implements Runnable, ChangeListener, BasicRequester {
	...
	public UnsharpMaskTool(ImageView imageView) {
		...
		engine = new UnsharpMask(targetLayer, tmpLayer);
	...
	public void run() {
		...
		engine.unsharpMask(sigma, k);

		now = System.currentTimeMillis() - now;
		System.out.printf("unsharp: sigma %f k %f took %03d.%03ds\n", sigma, k, now / 1000, now % 1000);
