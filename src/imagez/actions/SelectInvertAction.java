 ...
 * @author notzed
 */
public class SelectInvertAction extends AbstractWindowAction {

	public SelectInvertAction() {
		super("Invert Selection", null);
	...
	public void actionPerformed(ActionEvent e) {
		...
		sm.updateSelection(sm.MODE_XOR, new Rectangle(win.getImageView().getImage().getDimension()), false);
	}
}
